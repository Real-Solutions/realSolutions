...
@Index(name = "byUserType", fields = {"userTypeId","name"})
public final class User implements Model {
  ...
  private User(String id, String name, UserType userType) {
    this.id = id;
    this.name = name;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, UserType userType) {
      super.id(id);
      super.name(name)
        .userType(userType);
    }
